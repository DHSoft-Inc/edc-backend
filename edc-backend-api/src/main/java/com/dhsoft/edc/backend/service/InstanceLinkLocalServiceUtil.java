...
/**
 * Provides the local service utility for InstanceLink. This utility wraps
 * <code>com.dhsoft.edc.backend.service.impl.InstanceLinkLocalServiceImpl</code> and
 ...
 * @generated
 */
public class InstanceLinkLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.dhsoft.edc.backend.service.impl.InstanceLinkLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static InstanceLink addInstanceLink(InstanceLink instanceLink) {
		return getService().addInstanceLink(instanceLink);
	}
	 ...
	 */
	public static InstanceLink createInstanceLink(long linkId) {
		return getService().createInstanceLink(linkId);
	}
	 ...
	 */
	public static InstanceLink deleteInstanceLink(InstanceLink instanceLink) {
		return getService().deleteInstanceLink(instanceLink);
	}
	 ...
	 */
	public static InstanceLink deleteInstanceLink(long linkId)
		throws PortalException {

		return getService().deleteInstanceLink(linkId);
	}
	...
	public static InstanceLink fetchInstanceLink(long linkId) {
		return getService().fetchInstanceLink(linkId);
	}
	 ...
	 */
	public static InstanceLink fetchInstanceLinkByUuidAndGroupId(
	 ...
	 * @throws PortalException if a instance link with the primary key could not be found
	 */
	public static InstanceLink getInstanceLink(long linkId)
		throws PortalException {

		return getService().getInstanceLink(linkId);
	}
	 ...
	 */
	public static InstanceLink getInstanceLinkByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return getService().getInstanceLinkByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 */
	public static List<InstanceLink> getInstanceLinks(int start, int end) {
		return getService().getInstanceLinks(start, end);
	}
	 ...
	 */
	public static List<InstanceLink> getInstanceLinksByUuidAndCompanyId(
		String uuid, long companyId) {

		return getService().getInstanceLinksByUuidAndCompanyId(uuid, companyId);
	}
	...
	public static List<InstanceLink> getInstanceLinksByUuidAndCompanyId(
		...
		return getService().getInstanceLinksByUuidAndCompanyId(
	 ...
	 */
	public static int getInstanceLinksCount() {
		return getService().getInstanceLinksCount();
	}
	 ...
	 */
	public static InstanceLink updateInstanceLink(InstanceLink instanceLink) {
		return getService().updateInstanceLink(instanceLink);
	}

	public static InstanceLinkLocalService getService() {
		return _service;
	}

	private static volatile InstanceLinkLocalService _service;
