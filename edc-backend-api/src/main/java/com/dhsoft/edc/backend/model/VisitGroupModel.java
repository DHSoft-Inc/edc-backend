...
/**
 * The base model interface for the VisitGroup service. Represents a row in the &quot;EDC_VisitGroup&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.dhsoft.edc.backend.model.impl.VisitGroupModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.dhsoft.edc.backend.model.impl.VisitGroupImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface VisitGroupModel
	extends BaseModel<VisitGroup>, GroupedModel, ShardedModel,
			StagedAuditedModel, TrashedModel, WorkflowedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a visit group model instance should use the {@link VisitGroup} interface instead.
	 */
