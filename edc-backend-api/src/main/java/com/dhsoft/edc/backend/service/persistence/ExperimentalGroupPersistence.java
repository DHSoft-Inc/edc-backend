...
public interface ExperimentalGroupPersistence
	 ...
	 * @return the matching experimental groups
	 */
	public java.util.List<ExperimentalGroup> findByCompanyId(long companyId);
	 ...
	 * @return the range of matching experimental groups
	 */
	public java.util.List<ExperimentalGroup> findByCompanyId(
	 ...
	 * @return the matching experimental groups
	 */
	public java.util.List<ExperimentalGroup> findByG_P(
	 ...
	 * @return the matching experimental groups
	 */
	public java.util.List<ExperimentalGroup> findByUserId(long userId);
	 ...
	 * @return the range of matching experimental groups
	 */
	public java.util.List<ExperimentalGroup> findByUserId(
