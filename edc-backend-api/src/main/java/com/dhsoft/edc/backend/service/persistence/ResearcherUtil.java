...
public class ResearcherUtil {
	 ...
	 * @return the matching researchers
	 */
	public static List<Researcher> findByResearcherUserId(
	...
	public static List<Researcher> findByResearcherUserId(
		...
		return getPersistence().findByResearcherUserId(
			researcherUserId, start, end);
	}
	...
	public static List<Researcher> findByResearcherUserId(
		...
		return getPersistence().findByResearcherUserId(
			researcherUserId, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 * @throws NoSuchResearcherException if a matching researcher could not be found
	 */
	public static Researcher findByResearcherUserId_First(
			long researcherUserId,
			OrderByComparator<Researcher> orderByComparator)
		throws com.dhsoft.edc.backend.exception.NoSuchResearcherException {

		return getPersistence().findByResearcherUserId_First(
	 ...
	 * @return the first matching researcher, or <code>null</code> if a matching researcher could not be found
	 */
	public static Researcher fetchByResearcherUserId_First(
		long researcherUserId,
		OrderByComparator<Researcher> orderByComparator) {

		return getPersistence().fetchByResearcherUserId_First(
			researcherUserId, orderByComparator);
	}
	 ...
	 * @throws NoSuchResearcherException if a matching researcher could not be found
	 */
	public static Researcher findByResearcherUserId_Last(
			long researcherUserId,
			OrderByComparator<Researcher> orderByComparator)
		throws com.dhsoft.edc.backend.exception.NoSuchResearcherException {

		return getPersistence().findByResearcherUserId_Last(
			researcherUserId, orderByComparator);
	}
	 ...
	 * @return the last matching researcher, or <code>null</code> if a matching researcher could not be found
	 */
	public static Researcher fetchByResearcherUserId_Last(
		long researcherUserId,
		OrderByComparator<Researcher> orderByComparator) {

		return getPersistence().fetchByResearcherUserId_Last(
			researcherUserId, orderByComparator);
	}
	 ...
	 * @throws NoSuchResearcherException if a researcher with the primary key could not be found
	 */
	public static Researcher[] findByResearcherUserId_PrevAndNext(
			long researcherId, long researcherUserId,
			OrderByComparator<Researcher> orderByComparator)
		throws com.dhsoft.edc.backend.exception.NoSuchResearcherException {

		return getPersistence().findByResearcherUserId_PrevAndNext(
			researcherId, researcherUserId, orderByComparator);
	}
	 ...
	 * @param researcherUserId the researcher user ID
	 */
	public static void removeByResearcherUserId(long researcherUserId) {
		getPersistence().removeByResearcherUserId(researcherUserId);
	}
