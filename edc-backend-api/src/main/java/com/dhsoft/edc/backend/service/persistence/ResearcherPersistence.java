...
public interface ResearcherPersistence extends BasePersistence<Researcher> {
	 ...
	 * @return the matching researchers
	 */
	public java.util.List<Researcher> findByCompanyId(long companyId);
	 ...
	 * @return the range of matching researchers
	 */
	public java.util.List<Researcher> findByCompanyId(
	 ...
	 * @return the matching researchers
	 */
	public java.util.List<Researcher> findByU_R(
	 ...
	 * @return the matching researchers
	 */
	public java.util.List<Researcher> findByUserId(long userId);
	 ...
	 * @return the range of matching researchers
	 */
	public java.util.List<Researcher> findByUserId(
