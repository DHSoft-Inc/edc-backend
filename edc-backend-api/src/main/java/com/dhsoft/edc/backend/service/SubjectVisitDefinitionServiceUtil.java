 ...
 * @generated
 */
public class SubjectVisitDefinitionServiceUtil {
	...
	public static SubjectVisitDefinitionService getService() {
		return _service;
	}

	private static volatile SubjectVisitDefinitionService _service;
