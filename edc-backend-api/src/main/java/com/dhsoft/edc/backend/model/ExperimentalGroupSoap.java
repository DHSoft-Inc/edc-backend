...
/**
 * This class is used by SOAP remote services, specifically {@link com.dhsoft.edc.backend.service.http.ExperimentalGroupServiceSoap}.
 *
...
public class ExperimentalGroupSoap implements Serializable {
	...
	public static ExperimentalGroupSoap toSoapModel(ExperimentalGroup model) {
		...
		soapModel.setExpCode(model.getExpCode());
