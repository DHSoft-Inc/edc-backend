...
/**
 * Provides the local service interface for SubjectVisitDefinition. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SubjectVisitDefinitionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SubjectVisitDefinitionLocalService
