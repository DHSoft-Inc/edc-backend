...
/**
 * Provides the local service interface for InstanceLink. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see InstanceLinkLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface InstanceLinkLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.dhsoft.edc.backend.service.impl.InstanceLinkLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the instance link local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link InstanceLinkLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public InstanceLink addInstanceLink(InstanceLink instanceLink);
	...
	public InstanceLink createInstanceLink(long linkId);
	...
	public InstanceLink deleteInstanceLink(InstanceLink instanceLink);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public InstanceLink deleteInstanceLink(long linkId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public InstanceLink fetchInstanceLink(long linkId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public InstanceLink getInstanceLink(long linkId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public InstanceLink getInstanceLinkByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<InstanceLink> getInstanceLinks(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<InstanceLink> getInstanceLinksByUuidAndCompanyId(
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public InstanceLink updateInstanceLink(InstanceLink instanceLink);
