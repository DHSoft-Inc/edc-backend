...
public interface ProjectPersistence extends BasePersistence<Project> {
	 ...
	 * @return the matching projects
	 */
	public java.util.List<Project> findByCompanyId(long companyId);
	 ...
	 * @return the range of matching projects
	 */
	public java.util.List<Project> findByCompanyId(
	 ...
	 * @return the matching projects
	 */
	public java.util.List<Project> findByCode(String projectCode);
	 ...
	 * @return the range of matching projects
	 */
	public java.util.List<Project> findByCode(
