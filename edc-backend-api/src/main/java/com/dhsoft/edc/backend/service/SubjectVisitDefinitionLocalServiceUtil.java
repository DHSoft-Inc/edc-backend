...
/**
 * Provides the local service utility for SubjectVisitDefinition. This utility wraps
 * <code>com.dhsoft.edc.backend.service.impl.SubjectVisitDefinitionLocalServiceImpl</code> and
 ...
 * @generated
 */
public class SubjectVisitDefinitionLocalServiceUtil {
	 ...
	 */
	public static SubjectVisitDefinition addSubjectVisitDefinition(
	 ...
	 */
	public static SubjectVisitDefinition createSubjectVisitDefinition(
		long subjectVisitDefinitionId) {

		return getService().createSubjectVisitDefinition(
	 ...
	 */
	public static SubjectVisitDefinition deleteSubjectVisitDefinition(
			long subjectVisitDefinitionId)
		throws PortalException {

		return getService().deleteSubjectVisitDefinition(
			subjectVisitDefinitionId);
	}
	...
	public static SubjectVisitDefinition fetchSubjectVisitDefinition(
		long subjectVisitDefinitionId) {

		return getService().fetchSubjectVisitDefinition(
			subjectVisitDefinitionId);
	}
	 ...
	 */
	public static SubjectVisitDefinition
	 ...
	 * @throws PortalException if a subject visit definition with the primary key could not be found
	 */
	public static SubjectVisitDefinition getSubjectVisitDefinition(
			long subjectVisitDefinitionId)
		throws PortalException {

		return getService().getSubjectVisitDefinition(subjectVisitDefinitionId);
	}
	...
	public static SubjectVisitDefinition
		...
		return getService().getSubjectVisitDefinitionByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 */
	public static List<SubjectVisitDefinition> getSubjectVisitDefinitions(
		int start, int end) {

		return getService().getSubjectVisitDefinitions(start, end);
	}
	 ...
	 */
	public static List<SubjectVisitDefinition>
		getSubjectVisitDefinitionsByUuidAndCompanyId(
			String uuid, long companyId) {

		return getService().getSubjectVisitDefinitionsByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getSubjectVisitDefinitionsCount() {
		return getService().getSubjectVisitDefinitionsCount();
	}
	 ...
	 */
	public static SubjectVisitDefinition updateSubjectVisitDefinition(
		SubjectVisitDefinition subjectVisitDefinition) {

		return getService().updateSubjectVisitDefinition(
			subjectVisitDefinition);
	}

	public static SubjectVisitDefinitionLocalService getService() {
		return _service;
	}

	private static volatile SubjectVisitDefinitionLocalService _service;
