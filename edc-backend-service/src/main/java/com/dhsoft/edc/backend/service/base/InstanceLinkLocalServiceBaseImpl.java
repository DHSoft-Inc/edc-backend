...
import com.dhsoft.edc.backend.service.InstanceLinkLocalService;
...
/**
 * Provides the base implementation for the instance link local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.dhsoft.edc.backend.service.impl.InstanceLinkLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.dhsoft.edc.backend.service.impl.InstanceLinkLocalServiceImpl
 * @generated
 */
public abstract class InstanceLinkLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, InstanceLinkLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>InstanceLinkLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>InstanceLinkLocalServiceUtil</code>.
	 */
	...
	public InstanceLink addInstanceLink(InstanceLink instanceLink) {
		...
		return instanceLinkPersistence.update(instanceLink);
	}
	...
	public InstanceLink createInstanceLink(long linkId) {
		return instanceLinkPersistence.create(linkId);
	}
	...
	public InstanceLink deleteInstanceLink(long linkId) throws PortalException {
		return instanceLinkPersistence.remove(linkId);
	}
	...
	public InstanceLink deleteInstanceLink(InstanceLink instanceLink) {
		return instanceLinkPersistence.remove(instanceLink);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			InstanceLink.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return instanceLinkPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return instanceLinkPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return instanceLinkPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return instanceLinkPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public InstanceLink fetchInstanceLink(long linkId) {
		return instanceLinkPersistence.fetchByPrimaryKey(linkId);
	}
	...
	public InstanceLink fetchInstanceLinkByUuidAndGroupId(
		...
		return instanceLinkPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public InstanceLink getInstanceLink(long linkId) throws PortalException {
		return instanceLinkPersistence.findByPrimaryKey(linkId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(instanceLinkLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(InstanceLink.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(InstanceLink.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<InstanceLink>() {

				@Override
				public void performAction(InstanceLink instanceLink)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, instanceLink);
				}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return instanceLinkLocalService.deleteInstanceLink(
			(InstanceLink)persistedModel);
	}

	public BasePersistence<InstanceLink> getBasePersistence() {
		return instanceLinkPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return instanceLinkPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<InstanceLink> getInstanceLinksByUuidAndCompanyId(
		...
		return instanceLinkPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<InstanceLink> getInstanceLinksByUuidAndCompanyId(
		...
		return instanceLinkPersistence.findByUuid_C(
	...
	public InstanceLink getInstanceLinkByUuidAndGroupId(
		...
		return instanceLinkPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<InstanceLink> getInstanceLinks(int start, int end) {
		return instanceLinkPersistence.findAll(start, end);
	}
	...
	public int getInstanceLinksCount() {
		return instanceLinkPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			InstanceLinkLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		instanceLinkLocalService = (InstanceLinkLocalService)aopProxy;

		_setLocalServiceUtilService(instanceLinkLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return InstanceLinkLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = InstanceLinkLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, instanceLinkLocalService);
		}
	...
	protected InstanceLinkLocalService instanceLinkLocalService;
