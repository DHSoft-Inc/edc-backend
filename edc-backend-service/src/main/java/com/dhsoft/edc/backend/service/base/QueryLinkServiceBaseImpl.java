...
/**
 * Provides the base implementation for the query link remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.dhsoft.edc.backend.service.impl.QueryLinkServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.dhsoft.edc.backend.service.impl.QueryLinkServiceImpl
 * @generated
 */
public abstract class QueryLinkServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, QueryLinkService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QueryLinkService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>QueryLinkServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QueryLinkService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		queryLinkService = (QueryLinkService)aopProxy;

		_setServiceUtilService(queryLinkService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return QueryLinkService.class.getName();
	}
	...
	private void _setServiceUtilService(QueryLinkService queryLinkService) {
		try {
			Field field = QueryLinkServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, queryLinkService);
		}
	...
	@Reference
	protected com.dhsoft.edc.backend.service.QueryLinkLocalService
