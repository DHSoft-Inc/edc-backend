...
import com.dhsoft.edc.backend.exception.NoSuchProjectException;
import com.dhsoft.edc.backend.model.Project;
import com.dhsoft.edc.backend.model.impl.ProjectImpl;
import com.dhsoft.edc.backend.model.impl.ProjectModelImpl;
import com.dhsoft.edc.backend.service.persistence.ProjectPersistence;
import com.dhsoft.edc.backend.service.persistence.ProjectUtil;
...
public class ProjectPersistenceImpl
	 ...
	 */
	@Override
	public List<Project> findByCompanyId(
	 ...
	 */
	@Override
	public Project findByCompanyId_First(
	 ...
	 */
	@Override
	public Project fetchByCompanyId_First(
		long companyId, OrderByComparator<Project> orderByComparator) {

		List<Project> list = findByCompanyId(
	 ...
	 */
	@Override
	public Project findByCompanyId_Last(
			long companyId, OrderByComparator<Project> orderByComparator)
		throws NoSuchProjectException {
	 ...
	 */
	@Override
	public Project fetchByCompanyId_Last(
		long companyId, OrderByComparator<Project> orderByComparator) {
	 ...
	 */
	@Override
	public Project[] findByCompanyId_PrevAndNext(
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(
				session, project, companyId, orderByComparator, true);

			array[1] = project;

			array[2] = getByCompanyId_PrevAndNext(
				session, project, companyId, orderByComparator, false);
	...
	protected Project getByCompanyId_PrevAndNext(
		Session session, Project project, long companyId,
		OrderByComparator<Project> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public List<Project> findByCode(String projectCode) {
		return findByCode(
			projectCode, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<Project> findByCode(String projectCode, int start, int end) {
		return findByCode(projectCode, start, end, null);
	}
	 ...
	 */
	@Override
	public List<Project> findByCode(
		String projectCode, int start, int end,
		OrderByComparator<Project> orderByComparator) {

		return findByCode(projectCode, start, end, orderByComparator, true);
	}
	...
	public List<Project> findByCode(
		...
		projectCode = Objects.toString(projectCode, "");
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				...
				finderArgs = new Object[] {projectCode};
			}
		}
		else if (useFinderCache) {
		...
		if (list == null) {
			...
			if (projectCode.isEmpty()) {
				sb.append(_FINDER_COLUMN_CODE_PROJECTCODE_3);
			}
			else {
				bindProjectCode = true;

				sb.append(_FINDER_COLUMN_CODE_PROJECTCODE_2);
			}
	 ...
	 */
	@Override
	public Project findByCode_First(
			String projectCode, OrderByComparator<Project> orderByComparator)
		throws NoSuchProjectException {

		Project project = fetchByCode_First(projectCode, orderByComparator);
	 ...
	 */
	@Override
	public Project fetchByCode_First(
		String projectCode, OrderByComparator<Project> orderByComparator) {

		List<Project> list = findByCode(projectCode, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Project findByCode_Last(
			String projectCode, OrderByComparator<Project> orderByComparator)
		throws NoSuchProjectException {

		Project project = fetchByCode_Last(projectCode, orderByComparator);
	 ...
	 */
	@Override
	public Project fetchByCode_Last(
		String projectCode, OrderByComparator<Project> orderByComparator) {

		int count = countByCode(projectCode);

		if (count == 0) {
			return null;
		}

		List<Project> list = findByCode(
	 ...
	 */
	@Override
	public Project[] findByCode_PrevAndNext(
		...
		try {
			...
			array[0] = getByCode_PrevAndNext(
				session, project, projectCode, orderByComparator, true);

			array[1] = project;

			array[2] = getByCode_PrevAndNext(
				session, project, projectCode, orderByComparator, false);
	...
	protected Project getByCode_PrevAndNext(
		Session session, Project project, String projectCode,
		OrderByComparator<Project> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public void removeByCode(String projectCode) {
		for (Project project :
				findByCode(
					projectCode, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
	 ...
	 */
	@Override
	public int countByCode(String projectCode) {
		projectCode = Objects.toString(projectCode, "");
	...
	private static final String _FINDER_COLUMN_CODE_PROJECTCODE_2 =
		"project.projectCode = ?";

	private static final String _FINDER_COLUMN_CODE_PROJECTCODE_3 =
		"(project.projectCode IS NULL OR project.projectCode = '')";
	...
	public Project updateImpl(Project project) {
		...
		if (!_columnBitmaskEnabled) {
			...
			args = new Object[] {projectModelImpl.getProjectCode()};
			...
			if ((projectModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					projectModelImpl.getOriginalProjectCode()
				};
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByCode = new FinderPath(
			...
			new String[] {String.class.getName()},
			ProjectModelImpl.PROJECTCODE_COLUMN_BITMASK |
			ProjectModelImpl.CREATEDATE_COLUMN_BITMASK);
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.dhsoft.edc.backend.model.Project"),
			true);
	}
