...
import com.dhsoft.edc.backend.service.MetaGroupService;
import com.dhsoft.edc.backend.service.MetaGroupServiceUtil;
...
/**
 * Provides the base implementation for the meta group remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.dhsoft.edc.backend.service.impl.MetaGroupServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.dhsoft.edc.backend.service.impl.MetaGroupServiceImpl
 * @generated
 */
public abstract class MetaGroupServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, MetaGroupService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MetaGroupService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MetaGroupServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MetaGroupService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		metaGroupService = (MetaGroupService)aopProxy;

		_setServiceUtilService(metaGroupService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MetaGroupService.class.getName();
	}
	...
	private void _setServiceUtilService(MetaGroupService metaGroupService) {
		try {
			Field field = MetaGroupServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, metaGroupService);
		}
	...
	@Reference
	protected com.dhsoft.edc.backend.service.MetaGroupLocalService
		metaGroupLocalService;

	protected MetaGroupService metaGroupService;
