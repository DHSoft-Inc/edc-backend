...
/**
 * Provides the base implementation for the subject visit definition local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.dhsoft.edc.backend.service.impl.SubjectVisitDefinitionLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.dhsoft.edc.backend.service.impl.SubjectVisitDefinitionLocalServiceImpl
 * @generated
 */
public abstract class SubjectVisitDefinitionLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SubjectVisitDefinitionLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SubjectVisitDefinitionLocalServiceUtil</code>.
	 */
	...
	public SubjectVisitDefinition addSubjectVisitDefinition(
		...
		return subjectVisitDefinitionPersistence.update(subjectVisitDefinition);
	}
	...
	public SubjectVisitDefinition createSubjectVisitDefinition(
		...
		return subjectVisitDefinitionPersistence.create(
	...
	@Override
	public SubjectVisitDefinition deleteSubjectVisitDefinition(
			long subjectVisitDefinitionId)
		throws PortalException {

		return subjectVisitDefinitionPersistence.remove(
			subjectVisitDefinitionId);
	}
	...
	public SubjectVisitDefinition deleteSubjectVisitDefinition(
		...
		return subjectVisitDefinitionPersistence.remove(subjectVisitDefinition);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SubjectVisitDefinition.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return subjectVisitDefinitionPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return subjectVisitDefinitionPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public SubjectVisitDefinition fetchSubjectVisitDefinition(
		long subjectVisitDefinitionId) {

		return subjectVisitDefinitionPersistence.fetchByPrimaryKey(
			subjectVisitDefinitionId);
	}
	...
	public SubjectVisitDefinition fetchSubjectVisitDefinitionByUuidAndGroupId(
		...
		return subjectVisitDefinitionPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public SubjectVisitDefinition getSubjectVisitDefinition(
			long subjectVisitDefinitionId)
		throws PortalException {

		return subjectVisitDefinitionPersistence.findByPrimaryKey(
			subjectVisitDefinitionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SubjectVisitDefinition.class);
						...
						StagedModelDataHandler<?> stagedModelDataHandler =
							StagedModelDataHandlerRegistryUtil.
								getStagedModelDataHandler(
									SubjectVisitDefinition.class.getName());
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, subjectVisitDefinition);
				}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return subjectVisitDefinitionLocalService.deleteSubjectVisitDefinition(
			(SubjectVisitDefinition)persistedModel);
	}

	public BasePersistence<SubjectVisitDefinition> getBasePersistence() {
		return subjectVisitDefinitionPersistence;
	}
	 ...
	 */
	@Override
	public List<SubjectVisitDefinition>
		getSubjectVisitDefinitionsByUuidAndCompanyId(
			String uuid, long companyId) {

		return subjectVisitDefinitionPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<SubjectVisitDefinition>
		...
		return subjectVisitDefinitionPersistence.findByUuid_C(
	 ...
	 */
	@Override
	public SubjectVisitDefinition getSubjectVisitDefinitionByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return subjectVisitDefinitionPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<SubjectVisitDefinition> getSubjectVisitDefinitions(
		int start, int end) {

		return subjectVisitDefinitionPersistence.findAll(start, end);
	}
	...
	public int getSubjectVisitDefinitionsCount() {
		return subjectVisitDefinitionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SubjectVisitDefinition updateSubjectVisitDefinition(
		SubjectVisitDefinition subjectVisitDefinition) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SubjectVisitDefinitionLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		subjectVisitDefinitionLocalService =
			(SubjectVisitDefinitionLocalService)aopProxy;

		_setLocalServiceUtilService(subjectVisitDefinitionLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SubjectVisitDefinitionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				subjectVisitDefinitionPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				SubjectVisitDefinitionLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, subjectVisitDefinitionLocalService);
		}
	...
	protected SubjectVisitDefinitionLocalService
		subjectVisitDefinitionLocalService;
