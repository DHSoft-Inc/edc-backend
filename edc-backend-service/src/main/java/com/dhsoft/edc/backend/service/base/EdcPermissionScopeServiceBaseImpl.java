...
import com.dhsoft.edc.backend.service.EdcPermissionScopeService;
import com.dhsoft.edc.backend.service.EdcPermissionScopeServiceUtil;
...
/**
 * Provides the base implementation for the edc permission scope remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.dhsoft.edc.backend.service.impl.EdcPermissionScopeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.dhsoft.edc.backend.service.impl.EdcPermissionScopeServiceImpl
 * @generated
 */
public abstract class EdcPermissionScopeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EdcPermissionScopeService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EdcPermissionScopeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>EdcPermissionScopeServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EdcPermissionScopeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		edcPermissionScopeService = (EdcPermissionScopeService)aopProxy;

		_setServiceUtilService(edcPermissionScopeService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return EdcPermissionScopeService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = EdcPermissionScopeServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, edcPermissionScopeService);
		}
	...
	@Reference
	protected com.dhsoft.edc.backend.service.EdcPermissionScopeLocalService
		edcPermissionScopeLocalService;

	protected EdcPermissionScopeService edcPermissionScopeService;
