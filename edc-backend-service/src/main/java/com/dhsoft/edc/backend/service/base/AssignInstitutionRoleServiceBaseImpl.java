...
import com.dhsoft.edc.backend.service.AssignInstitutionRoleService;
import com.dhsoft.edc.backend.service.AssignInstitutionRoleServiceUtil;
...
/**
 * Provides the base implementation for the assign institution role remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.dhsoft.edc.backend.service.impl.AssignInstitutionRoleServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.dhsoft.edc.backend.service.impl.AssignInstitutionRoleServiceImpl
 * @generated
 */
public abstract class AssignInstitutionRoleServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, AssignInstitutionRoleService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AssignInstitutionRoleService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>AssignInstitutionRoleServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AssignInstitutionRoleService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		assignInstitutionRoleService = (AssignInstitutionRoleService)aopProxy;

		_setServiceUtilService(assignInstitutionRoleService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return AssignInstitutionRoleService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				AssignInstitutionRoleServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, assignInstitutionRoleService);
		}
	...
	@Reference
	protected com.dhsoft.edc.backend.service.AssignInstitutionRoleLocalService
		assignInstitutionRoleLocalService;

	protected AssignInstitutionRoleService assignInstitutionRoleService;
