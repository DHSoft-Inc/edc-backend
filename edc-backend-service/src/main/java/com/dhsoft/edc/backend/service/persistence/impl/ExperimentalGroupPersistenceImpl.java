...
import com.dhsoft.edc.backend.exception.NoSuchExperimentalGroupException;
import com.dhsoft.edc.backend.model.ExperimentalGroup;
import com.dhsoft.edc.backend.model.impl.ExperimentalGroupImpl;
import com.dhsoft.edc.backend.model.impl.ExperimentalGroupModelImpl;
import com.dhsoft.edc.backend.service.persistence.ExperimentalGroupPersistence;
import com.dhsoft.edc.backend.service.persistence.ExperimentalGroupUtil;
...
public class ExperimentalGroupPersistenceImpl
	 ...
	 */
	@Override
	public List<ExperimentalGroup> findByCompanyId(long companyId) {
	 ...
	 */
	@Override
	public List<ExperimentalGroup> findByCompanyId(
	...
	public List<ExperimentalGroup> findByCompanyId(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (ExperimentalGroup experimentalGroup : list) {
					if (companyId != experimentalGroup.getCompanyId()) {
						list = null;
	 ...
	 */
	@Override
	public ExperimentalGroup findByCompanyId_First(
			long companyId,
			OrderByComparator<ExperimentalGroup> orderByComparator)
		throws NoSuchExperimentalGroupException {

		ExperimentalGroup experimentalGroup = fetchByCompanyId_First(
	 ...
	 */
	@Override
	public ExperimentalGroup fetchByCompanyId_First(
		long companyId,
		OrderByComparator<ExperimentalGroup> orderByComparator) {

		List<ExperimentalGroup> list = findByCompanyId(
	 ...
	 */
	@Override
	public ExperimentalGroup findByCompanyId_Last(
			long companyId,
			OrderByComparator<ExperimentalGroup> orderByComparator)
		throws NoSuchExperimentalGroupException {

		ExperimentalGroup experimentalGroup = fetchByCompanyId_Last(
			companyId, orderByComparator);
	 ...
	 */
	@Override
	public ExperimentalGroup fetchByCompanyId_Last(
		long companyId,
		OrderByComparator<ExperimentalGroup> orderByComparator) {
	 ...
	 */
	@Override
	public ExperimentalGroup[] findByCompanyId_PrevAndNext(
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(
				session, experimentalGroup, companyId, orderByComparator, true);

			array[1] = experimentalGroup;

			array[2] = getByCompanyId_PrevAndNext(
				session, experimentalGroup, companyId, orderByComparator,
				false);
	...
	protected ExperimentalGroup getByCompanyId_PrevAndNext(
		Session session, ExperimentalGroup experimentalGroup, long companyId,
		OrderByComparator<ExperimentalGroup> orderByComparator,
		boolean previous) {
	...
	private FinderPath _finderPathFetchByG_P_E;
	private FinderPath _finderPathCountByG_P_E;
	...
	public ExperimentalGroup findByG_P_E(
		...
		ExperimentalGroup experimentalGroup = fetchByG_P_E(
	...
	public ExperimentalGroup fetchByG_P_E(
		...
		return fetchByG_P_E(groupId, projectId, expCode, true);
	}
	...
	public ExperimentalGroup fetchByG_P_E(
		...
		expCode = Objects.toString(expCode, "");

		Object[] finderArgs = null;

		if (useFinderCache) {
			finderArgs = new Object[] {groupId, projectId, expCode};
		}
		...
		if (useFinderCache) {
			result = finderCache.getResult(
				_finderPathFetchByG_P_E, finderArgs, this);
		}
		...
		if (result instanceof ExperimentalGroup) {
			...
			if ((groupId != experimentalGroup.getGroupId()) ||
				...
				!Objects.equals(expCode, experimentalGroup.getExpCode())) {
		...
		if (result == null) {
			...
			sb.append(_FINDER_COLUMN_G_P_E_GROUPID_2);

			sb.append(_FINDER_COLUMN_G_P_E_PROJECTID_2);

			boolean bindExpCode = false;

			if (expCode.isEmpty()) {
				sb.append(_FINDER_COLUMN_G_P_E_EXPCODE_3);
			}
			else {
				bindExpCode = true;

				sb.append(_FINDER_COLUMN_G_P_E_EXPCODE_2);
			}
			...
			try {
				...
				if (list.isEmpty()) {
					if (useFinderCache) {
						finderCache.putResult(
							_finderPathFetchByG_P_E, finderArgs, list);
					}
				}
				else {
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"ExperimentalGroupPersistenceImpl.fetchByG_P_E(long, long, String, boolean) with parameters (" +
				...
				if (useFinderCache) {
					finderCache.removeResult(
						_finderPathFetchByG_P_E, finderArgs);
				}
	...
	public ExperimentalGroup removeByG_P_E(
		...
		ExperimentalGroup experimentalGroup = findByG_P_E(
			groupId, projectId, expCode);
	...
	public int countByG_P_E(long groupId, long projectId, String expCode) {
		...
		FinderPath finderPath = _finderPathCountByG_P_E;

		Object[] finderArgs = new Object[] {groupId, projectId, expCode};
	...
	private static final String _FINDER_COLUMN_G_P_E_GROUPID_2 =
		"experimentalGroup.groupId = ? AND ";

	private static final String _FINDER_COLUMN_G_P_E_PROJECTID_2 =
		"experimentalGroup.projectId = ? AND ";

	private static final String _FINDER_COLUMN_G_P_E_EXPCODE_2 =
		"experimentalGroup.expCode = ?";

	private static final String _FINDER_COLUMN_G_P_E_EXPCODE_3 =
		"(experimentalGroup.expCode IS NULL OR experimentalGroup.expCode = '')";
	 ...
	 */
	@Override
	public List<ExperimentalGroup> findByG_P(long groupId, long projectId) {
		return findByG_P(
	 ...
	 */
	@Override
	public List<ExperimentalGroup> findByG_P(
	 ...
	 */
	@Override
	public ExperimentalGroup findByG_P_First(
			long groupId, long projectId,
			OrderByComparator<ExperimentalGroup> orderByComparator)
		throws NoSuchExperimentalGroupException {

		ExperimentalGroup experimentalGroup = fetchByG_P_First(
	 ...
	 */
	@Override
	public ExperimentalGroup fetchByG_P_First(
		long groupId, long projectId,
		OrderByComparator<ExperimentalGroup> orderByComparator) {

		List<ExperimentalGroup> list = findByG_P(
	 ...
	 */
	@Override
	public ExperimentalGroup findByG_P_Last(
			long groupId, long projectId,
			OrderByComparator<ExperimentalGroup> orderByComparator)
		throws NoSuchExperimentalGroupException {

		ExperimentalGroup experimentalGroup = fetchByG_P_Last(
			groupId, projectId, orderByComparator);
	 ...
	 */
	@Override
	public ExperimentalGroup fetchByG_P_Last(
		long groupId, long projectId,
		OrderByComparator<ExperimentalGroup> orderByComparator) {
	 ...
	 */
	@Override
	public ExperimentalGroup[] findByG_P_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_P_PrevAndNext(
				session, experimentalGroup, groupId, projectId,
	...
	protected ExperimentalGroup getByG_P_PrevAndNext(
		Session session, ExperimentalGroup experimentalGroup, long groupId,
		long projectId, OrderByComparator<ExperimentalGroup> orderByComparator,
		boolean previous) {
	 ...
	 */
	@Override
	public List<ExperimentalGroup> findByUserId(long userId) {
	 ...
	 */
	@Override
	public List<ExperimentalGroup> findByUserId(
	...
	public List<ExperimentalGroup> findByUserId(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (ExperimentalGroup experimentalGroup : list) {
					if (userId != experimentalGroup.getUserId()) {
						list = null;
	 ...
	 */
	@Override
	public ExperimentalGroup findByUserId_First(
			long userId, OrderByComparator<ExperimentalGroup> orderByComparator)
		throws NoSuchExperimentalGroupException {

		ExperimentalGroup experimentalGroup = fetchByUserId_First(
	 ...
	 */
	@Override
	public ExperimentalGroup fetchByUserId_First(
		long userId, OrderByComparator<ExperimentalGroup> orderByComparator) {

		List<ExperimentalGroup> list = findByUserId(
	 ...
	 */
	@Override
	public ExperimentalGroup findByUserId_Last(
			long userId, OrderByComparator<ExperimentalGroup> orderByComparator)
		throws NoSuchExperimentalGroupException {

		ExperimentalGroup experimentalGroup = fetchByUserId_Last(
			userId, orderByComparator);
	 ...
	 */
	@Override
	public ExperimentalGroup fetchByUserId_Last(
		long userId, OrderByComparator<ExperimentalGroup> orderByComparator) {
	 ...
	 */
	@Override
	public ExperimentalGroup[] findByUserId_PrevAndNext(
		...
		try {
			...
			array[0] = getByUserId_PrevAndNext(
				session, experimentalGroup, userId, orderByComparator, true);

			array[1] = experimentalGroup;

			array[2] = getByUserId_PrevAndNext(
				session, experimentalGroup, userId, orderByComparator, false);
	...
	protected ExperimentalGroup getByUserId_PrevAndNext(
		Session session, ExperimentalGroup experimentalGroup, long userId,
		OrderByComparator<ExperimentalGroup> orderByComparator,
		boolean previous) {
	...
	public void cacheResult(ExperimentalGroup experimentalGroup) {
		...
		finderCache.putResult(
			_finderPathFetchByG_P_E,
			new Object[] {
				experimentalGroup.getGroupId(),
				experimentalGroup.getProjectId(), experimentalGroup.getExpCode()
			},
			experimentalGroup);
	...
	protected void cacheUniqueFindersCache(
		...
		args = new Object[] {
			experimentalGroupModelImpl.getGroupId(),
			experimentalGroupModelImpl.getProjectId(),
			experimentalGroupModelImpl.getExpCode()
		};

		finderCache.putResult(
			_finderPathCountByG_P_E, args, Long.valueOf(1), false);
		finderCache.putResult(
			_finderPathFetchByG_P_E, args, experimentalGroupModelImpl, false);
	}
	...
	protected void clearUniqueFindersCache(
		...
		if (clearCurrent) {
			...
			finderCache.removeResult(_finderPathCountByG_P_E, args);
			finderCache.removeResult(_finderPathFetchByG_P_E, args);
		}

		if ((experimentalGroupModelImpl.getColumnBitmask() &
			 _finderPathFetchByG_P_E.getColumnBitmask()) != 0) {

			Object[] args = new Object[] {
				experimentalGroupModelImpl.getOriginalGroupId(),
				experimentalGroupModelImpl.getOriginalProjectId(),
				experimentalGroupModelImpl.getOriginalExpCode()
			};
	...
	public ExperimentalGroup updateImpl(ExperimentalGroup experimentalGroup) {
		...
		if (!_columnBitmaskEnabled) {
			...
			args = new Object[] {experimentalGroupModelImpl.getCompanyId()};
			...
			args = new Object[] {experimentalGroupModelImpl.getUserId()};
			...
			if ((experimentalGroupModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					experimentalGroupModelImpl.getOriginalUserId()
				};
	...
	public void activate() {
		...
		_finderPathFetchByG_P_E = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, ExperimentalGroupImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByG_P_E",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName()
			},
			ExperimentalGroupModelImpl.GROUPID_COLUMN_BITMASK |
			ExperimentalGroupModelImpl.PROJECTID_COLUMN_BITMASK |
			ExperimentalGroupModelImpl.EXPCODE_COLUMN_BITMASK);

		_finderPathCountByG_P_E = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_P_E",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName()
			});
		...
		_finderPathWithoutPaginationFindByUserId = new FinderPath(
			...
			new String[] {Long.class.getName()},
			ExperimentalGroupModelImpl.USERID_COLUMN_BITMASK);
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.dhsoft.edc.backend.model.ExperimentalGroup"),
			true);
	}
