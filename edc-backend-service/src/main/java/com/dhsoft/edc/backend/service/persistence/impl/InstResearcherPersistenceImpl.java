...
public class InstResearcherPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByG_I;
	private FinderPath _finderPathWithoutPaginationFindByG_I;
	 ...
	 */
	@Override
	public List<InstResearcher> findByG_I(long groupId, long institutionId) {
		return findByG_I(
			groupId, institutionId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<InstResearcher> findByG_I(
		long groupId, long institutionId, int start, int end) {

		return findByG_I(groupId, institutionId, start, end, null);
	}
	...
	public List<InstResearcher> findByG_I(
		...
		return findByG_I(
			groupId, institutionId, start, end, orderByComparator, true);
	}
	...
	public List<InstResearcher> findByG_I(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByG_I;
				finderArgs = new Object[] {groupId, institutionId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByG_I;
			finderArgs = new Object[] {
	...
	public InstResearcher findByG_I_First(
		...
		InstResearcher instResearcher = fetchByG_I_First(
	...
	public InstResearcher fetchByG_I_First(
		...
		List<InstResearcher> list = findByG_I(
			groupId, institutionId, 0, 1, orderByComparator);
	...
	public InstResearcher findByG_I_Last(
		...
		InstResearcher instResearcher = fetchByG_I_Last(
			groupId, institutionId, orderByComparator);
	...
	public InstResearcher fetchByG_I_Last(
		...
		int count = countByG_I(groupId, institutionId);
		...
		List<InstResearcher> list = findByG_I(
			groupId, institutionId, count - 1, count, orderByComparator);
	...
	public InstResearcher[] findByG_I_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_I_PrevAndNext(
				session, instResearcher, groupId, institutionId,
				orderByComparator, true);

			array[1] = instResearcher;

			array[2] = getByG_I_PrevAndNext(
				session, instResearcher, groupId, institutionId,
	...
	protected InstResearcher getByG_I_PrevAndNext(
		Session session, InstResearcher instResearcher, long groupId,
		long institutionId, OrderByComparator<InstResearcher> orderByComparator,
		boolean previous) {
	...
	public void removeByG_I(long groupId, long institutionId) {
		for (InstResearcher instResearcher :
				findByG_I(
					groupId, institutionId, QueryUtil.ALL_POS,
	 ...
	 */
	@Override
	public List<InstResearcher> findByG_R(long groupId, long researcherId) {
		return findByG_R(
	 ...
	 */
	@Override
	public List<InstResearcher> findByG_R(
	...
	public InstResearcher findByG_R_First(
		...
		InstResearcher instResearcher = fetchByG_R_First(
	...
	public InstResearcher fetchByG_R_First(
		...
		List<InstResearcher> list = findByG_R(
	...
	public InstResearcher findByG_R_Last(
		...
		InstResearcher instResearcher = fetchByG_R_Last(
			groupId, researcherId, orderByComparator);
	...
	public InstResearcher[] findByG_R_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_R_PrevAndNext(
				session, instResearcher, groupId, researcherId,
				orderByComparator, true);
	...
	protected InstResearcher getByG_R_PrevAndNext(
		Session session, InstResearcher instResearcher, long groupId,
		long researcherId, OrderByComparator<InstResearcher> orderByComparator,
		boolean previous) {
	...
	private FinderPath _finderPathWithPaginationFindByG_P_I;
	private FinderPath _finderPathWithoutPaginationFindByG_P_I;
	private FinderPath _finderPathCountByG_P_I;
	 ...
	 */
	@Override
	public List<InstResearcher> findByG_P_I(
		long groupId, long projectId, long institutionId) {

		return findByG_P_I(
			groupId, projectId, institutionId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<InstResearcher> findByG_P_I(
		...
		return findByG_P_I(groupId, projectId, institutionId, start, end, null);
	}
	...
	public List<InstResearcher> findByG_P_I(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByG_P_I;
				finderArgs = new Object[] {groupId, projectId, institutionId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByG_P_I;
			finderArgs = new Object[] {
				groupId, projectId, institutionId, start, end, orderByComparator
			};
		}
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_G_P_I_GROUPID_2);

			sb.append(_FINDER_COLUMN_G_P_I_PROJECTID_2);

			sb.append(_FINDER_COLUMN_G_P_I_INSTITUTIONID_2);
	...
	public InstResearcher findByG_P_I_First(
		...
		InstResearcher instResearcher = fetchByG_P_I_First(
	...
	public InstResearcher fetchByG_P_I_First(
		...
		List<InstResearcher> list = findByG_P_I(
			groupId, projectId, institutionId, 0, 1, orderByComparator);
	...
	public InstResearcher findByG_P_I_Last(
		...
		InstResearcher instResearcher = fetchByG_P_I_Last(
			groupId, projectId, institutionId, orderByComparator);
	...
	public InstResearcher fetchByG_P_I_Last(
		...
		int count = countByG_P_I(groupId, projectId, institutionId);
		...
		List<InstResearcher> list = findByG_P_I(
			groupId, projectId, institutionId, count - 1, count,
			orderByComparator);
	...
	public InstResearcher[] findByG_P_I_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_P_I_PrevAndNext(
				session, instResearcher, groupId, projectId, institutionId,
				orderByComparator, true);

			array[1] = instResearcher;

			array[2] = getByG_P_I_PrevAndNext(
				session, instResearcher, groupId, projectId, institutionId,
				orderByComparator, false);
	...
	protected InstResearcher getByG_P_I_PrevAndNext(
		Session session, InstResearcher instResearcher, long groupId,
		long projectId, long institutionId,
		OrderByComparator<InstResearcher> orderByComparator, boolean previous) {
	...
	public int countByG_P_I(long groupId, long projectId, long institutionId) {
		FinderPath finderPath = _finderPathCountByG_P_I;

		Object[] finderArgs = new Object[] {groupId, projectId, institutionId};
	...
	private static final String _FINDER_COLUMN_G_P_I_GROUPID_2 =
		"instResearcher.groupId = ? AND ";

	private static final String _FINDER_COLUMN_G_P_I_PROJECTID_2 =
		"instResearcher.projectId = ? AND ";

	private static final String _FINDER_COLUMN_G_P_I_INSTITUTIONID_2 =
		"instResearcher.institutionId = ?";
	...
	public InstResearcher findByG_P_R(
		...
		InstResearcher instResearcher = fetchByG_P_R(
			groupId, projectId, researcherId);
	...
	public InstResearcher fetchByG_P_R(
		...
		return fetchByG_P_R(groupId, projectId, researcherId, true);
	}
	...
	public InstResearcher fetchByG_P_R(
		...
		if (useFinderCache) {
			finderArgs = new Object[] {groupId, projectId, researcherId};
		}
		...
		if (result == null) {
			...
			sb.append(_FINDER_COLUMN_G_P_R_RESEARCHERID_2);
	...
	public InstResearcher removeByG_P_R(
		...
		InstResearcher instResearcher = findByG_P_R(
			groupId, projectId, researcherId);
	...
	public int countByG_P_R(long groupId, long projectId, long researcherId) {
		...
		Object[] finderArgs = new Object[] {groupId, projectId, researcherId};
	...
	private static final String _FINDER_COLUMN_G_P_R_RESEARCHERID_2 =
		"instResearcher.researcherId = ?";

	private FinderPath _finderPathFetchByG_P_I_R;
	private FinderPath _finderPathCountByG_P_I_R;
	...
	public InstResearcher findByG_P_I_R(long researcherId)
		...
		InstResearcher instResearcher = fetchByG_P_I_R(researcherId);
	...
	public InstResearcher fetchByG_P_I_R(long researcherId) {
		return fetchByG_P_I_R(researcherId, true);
	}
	...
	public InstResearcher fetchByG_P_I_R(
		...
		if (useFinderCache) {
			result = finderCache.getResult(
				_finderPathFetchByG_P_I_R, finderArgs, this);
		}
		...
		if (result == null) {
			...
			sb.append(_FINDER_COLUMN_G_P_I_R_RESEARCHERID_2);
			...
			try {
				...
				if (list.isEmpty()) {
					if (useFinderCache) {
						finderCache.putResult(
							_finderPathFetchByG_P_I_R, finderArgs, list);
					}
				}
				else {
					InstResearcher instResearcher = list.get(0);
				...
				if (useFinderCache) {
					finderCache.removeResult(
						_finderPathFetchByG_P_I_R, finderArgs);
				}
	...
	public InstResearcher removeByG_P_I_R(long researcherId)
		...
		InstResearcher instResearcher = findByG_P_I_R(researcherId);
	...
	public int countByG_P_I_R(long researcherId) {
		FinderPath finderPath = _finderPathCountByG_P_I_R;
	...
	private static final String _FINDER_COLUMN_G_P_I_R_RESEARCHERID_2 =
		"instResearcher.researcherId = ?";
	...
	public void cacheResult(InstResearcher instResearcher) {
		...
		finderCache.putResult(
			...
			new Object[] {
				instResearcher.getGroupId(), instResearcher.getProjectId(),
				instResearcher.getResearcherId()
			},
			instResearcher);

		finderCache.putResult(
			_finderPathFetchByG_P_I_R,
			new Object[] {instResearcher.getResearcherId()}, instResearcher);
	...
	protected void cacheUniqueFindersCache(
		...
		args = new Object[] {
			...
			instResearcherModelImpl.getResearcherId()
		};

		finderCache.putResult(
			_finderPathCountByG_P_R, args, Long.valueOf(1), false);
		finderCache.putResult(
			_finderPathFetchByG_P_R, args, instResearcherModelImpl, false);

		args = new Object[] {instResearcherModelImpl.getResearcherId()};

		finderCache.putResult(
			_finderPathCountByG_P_I_R, args, Long.valueOf(1), false);
		finderCache.putResult(
			_finderPathFetchByG_P_I_R, args, instResearcherModelImpl, false);
	}
	...
	protected void clearUniqueFindersCache(
		...
		if (clearCurrent) {
			...
			finderCache.removeResult(_finderPathCountByG_P_I_R, args);
			finderCache.removeResult(_finderPathFetchByG_P_I_R, args);
		}

		if ((instResearcherModelImpl.getColumnBitmask() &
			 _finderPathFetchByG_P_I_R.getColumnBitmask()) != 0) {
	...
	public InstResearcher updateImpl(InstResearcher instResearcher) {
		...
		if (!_columnBitmaskEnabled) {
			...
			finderCache.removeResult(
				_finderPathWithoutPaginationFindByG_I, args);
			...
			finderCache.removeResult(_finderPathCountByG_P_I, args);
			finderCache.removeResult(
				_finderPathWithoutPaginationFindByG_P_I, args);
			...
			if ((instResearcherModelImpl.getColumnBitmask() &
				 _finderPathWithoutPaginationFindByG_I.getColumnBitmask()) !=
					 0) {
			...
			if ((instResearcherModelImpl.getColumnBitmask() &
				 _finderPathWithoutPaginationFindByG_P_I.getColumnBitmask()) !=
					 0) {
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByG_I = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, InstResearcherImpl.class,
		...
		_finderPathWithoutPaginationFindByG_I = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, InstResearcherImpl.class,
		...
		_finderPathWithPaginationFindByG_P_I = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, InstResearcherImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_P_I",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByG_P_I = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, InstResearcherImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_P_I",
			new String[] {
		...
		_finderPathCountByG_P_I = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_P_I",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName()
			});
		...
		_finderPathFetchByG_P_I_R = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, InstResearcherImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByG_P_I_R",
			new String[] {Long.class.getName()},
			InstResearcherModelImpl.RESEARCHERID_COLUMN_BITMASK);

		_finderPathCountByG_P_I_R = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_P_I_R",
			new String[] {Long.class.getName()});
