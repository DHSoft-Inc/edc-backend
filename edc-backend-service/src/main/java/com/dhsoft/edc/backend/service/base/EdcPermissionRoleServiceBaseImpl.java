...
import com.dhsoft.edc.backend.service.EdcPermissionRoleService;
import com.dhsoft.edc.backend.service.EdcPermissionRoleServiceUtil;
...
/**
 * Provides the base implementation for the edc permission role remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.dhsoft.edc.backend.service.impl.EdcPermissionRoleServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.dhsoft.edc.backend.service.impl.EdcPermissionRoleServiceImpl
 * @generated
 */
public abstract class EdcPermissionRoleServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EdcPermissionRoleService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EdcPermissionRoleService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>EdcPermissionRoleServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EdcPermissionRoleService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		edcPermissionRoleService = (EdcPermissionRoleService)aopProxy;

		_setServiceUtilService(edcPermissionRoleService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return EdcPermissionRoleService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = EdcPermissionRoleServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, edcPermissionRoleService);
		}
	...
	@Reference
	protected com.dhsoft.edc.backend.service.EdcPermissionRoleLocalService
		edcPermissionRoleLocalService;

	protected EdcPermissionRoleService edcPermissionRoleService;
