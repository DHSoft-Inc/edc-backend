...
/**
 * Provides the base implementation for the visit event local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.dhsoft.edc.backend.service.impl.VisitEventLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.dhsoft.edc.backend.service.impl.VisitEventLocalServiceImpl
 * @generated
 */
public abstract class VisitEventLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, VisitEventLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>VisitEventLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>VisitEventLocalServiceUtil</code>.
	 */
	...
	public VisitEvent addVisitEvent(VisitEvent visitEvent) {
		...
		return visitEventPersistence.update(visitEvent);
	}
	...
	public VisitEvent createVisitEvent(long visitEventId) {
		return visitEventPersistence.create(visitEventId);
	}
	...
	public VisitEvent deleteVisitEvent(long visitEventId)
		...
		return visitEventPersistence.remove(visitEventId);
	}
	...
	public VisitEvent deleteVisitEvent(VisitEvent visitEvent) {
		return visitEventPersistence.remove(visitEvent);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			VisitEvent.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return visitEventPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return visitEventPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return visitEventPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return visitEventPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public VisitEvent fetchVisitEvent(long visitEventId) {
		return visitEventPersistence.fetchByPrimaryKey(visitEventId);
	}
	...
	public VisitEvent fetchVisitEventByUuidAndGroupId(
		...
		return visitEventPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public VisitEvent getVisitEvent(long visitEventId) throws PortalException {
		return visitEventPersistence.findByPrimaryKey(visitEventId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(visitEventLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VisitEvent.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("visitEventId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(VisitEvent.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<VisitEvent>() {

				@Override
				public void performAction(VisitEvent visitEvent)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, visitEvent);
				}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return visitEventLocalService.deleteVisitEvent(
			(VisitEvent)persistedModel);
	}

	public BasePersistence<VisitEvent> getBasePersistence() {
		return visitEventPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return visitEventPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VisitEvent> getVisitEventsByUuidAndCompanyId(
		...
		return visitEventPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<VisitEvent> getVisitEventsByUuidAndCompanyId(
		...
		return visitEventPersistence.findByUuid_C(
	...
	public VisitEvent getVisitEventByUuidAndGroupId(String uuid, long groupId)
		...
		return visitEventPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<VisitEvent> getVisitEvents(int start, int end) {
		return visitEventPersistence.findAll(start, end);
	}
	...
	public int getVisitEventsCount() {
		return visitEventPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			VisitEventLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		visitEventLocalService = (VisitEventLocalService)aopProxy;

		_setLocalServiceUtilService(visitEventLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return VisitEventLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = VisitEventLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, visitEventLocalService);
		}
	...
	protected VisitEventLocalService visitEventLocalService;
