...
import com.dhsoft.edc.backend.service.InstResearcherService;
import com.dhsoft.edc.backend.service.InstResearcherServiceUtil;
...
/**
 * Provides the base implementation for the inst researcher remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.dhsoft.edc.backend.service.impl.InstResearcherServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.dhsoft.edc.backend.service.impl.InstResearcherServiceImpl
 * @generated
 */
public abstract class InstResearcherServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, InstResearcherService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>InstResearcherService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>InstResearcherServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			InstResearcherService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		instResearcherService = (InstResearcherService)aopProxy;

		_setServiceUtilService(instResearcherService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return InstResearcherService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = InstResearcherServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, instResearcherService);
		}
	...
	@Reference
	protected com.dhsoft.edc.backend.service.InstResearcherLocalService
		instResearcherLocalService;

	protected InstResearcherService instResearcherService;
