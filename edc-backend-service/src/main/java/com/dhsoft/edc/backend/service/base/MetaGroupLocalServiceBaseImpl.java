...
import com.dhsoft.edc.backend.service.MetaGroupLocalService;
...
/**
 * Provides the base implementation for the meta group local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.dhsoft.edc.backend.service.impl.MetaGroupLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.dhsoft.edc.backend.service.impl.MetaGroupLocalServiceImpl
 * @generated
 */
public abstract class MetaGroupLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, MetaGroupLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MetaGroupLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MetaGroupLocalServiceUtil</code>.
	 */
	...
	@Override
	public MetaGroup addMetaGroup(MetaGroup metaGroup) {
		metaGroup.setNew(true);

		return metaGroupPersistence.update(metaGroup);
	}
	...
	public MetaGroup createMetaGroup(long metaGroupId) {
		return metaGroupPersistence.create(metaGroupId);
	}
	...
	public MetaGroup deleteMetaGroup(long metaGroupId) throws PortalException {
		return metaGroupPersistence.remove(metaGroupId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MetaGroup deleteMetaGroup(MetaGroup metaGroup) {
		return metaGroupPersistence.remove(metaGroup);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MetaGroup.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return metaGroupPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return metaGroupPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return metaGroupPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return metaGroupPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public MetaGroup fetchMetaGroup(long metaGroupId) {
		return metaGroupPersistence.fetchByPrimaryKey(metaGroupId);
	}
	...
	public MetaGroup fetchMetaGroupByUuidAndGroupId(String uuid, long groupId) {
		return metaGroupPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public MetaGroup getMetaGroup(long metaGroupId) throws PortalException {
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(metaGroupLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(MetaGroup.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("metaGroupId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			metaGroupLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(MetaGroup.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<MetaGroup>() {

				@Override
				public void performAction(MetaGroup metaGroup)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, metaGroup);
				}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return metaGroupLocalService.deleteMetaGroup((MetaGroup)persistedModel);
	}

	public BasePersistence<MetaGroup> getBasePersistence() {
		return metaGroupPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return metaGroupPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MetaGroup> getMetaGroupsByUuidAndCompanyId(
		String uuid, long companyId) {

		return metaGroupPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<MetaGroup> getMetaGroupsByUuidAndCompanyId(
		...
		return metaGroupPersistence.findByUuid_C(
	 ...
	 */
	@Override
	public MetaGroup getMetaGroupByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {

		return metaGroupPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<MetaGroup> getMetaGroups(int start, int end) {
		return metaGroupPersistence.findAll(start, end);
	}
	...
	public int getMetaGroupsCount() {
		return metaGroupPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MetaGroupLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		metaGroupLocalService = (MetaGroupLocalService)aopProxy;

		_setLocalServiceUtilService(metaGroupLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MetaGroupLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = metaGroupPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = MetaGroupLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, metaGroupLocalService);
		}
	...
	protected MetaGroupLocalService metaGroupLocalService;
