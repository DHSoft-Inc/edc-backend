...
import com.dhsoft.edc.backend.service.VisitGroupService;
import com.dhsoft.edc.backend.service.VisitGroupServiceUtil;
...
/**
 * Provides the base implementation for the visit group remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.dhsoft.edc.backend.service.impl.VisitGroupServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.dhsoft.edc.backend.service.impl.VisitGroupServiceImpl
 * @generated
 */
public abstract class VisitGroupServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, VisitGroupService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>VisitGroupService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>VisitGroupServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			VisitGroupService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		visitGroupService = (VisitGroupService)aopProxy;

		_setServiceUtilService(visitGroupService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return VisitGroupService.class.getName();
	}
	...
	private void _setServiceUtilService(VisitGroupService visitGroupService) {
		try {
			Field field = VisitGroupServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, visitGroupService);
		}
	...
	@Reference
	protected com.dhsoft.edc.backend.service.VisitGroupLocalService
		visitGroupLocalService;

	protected VisitGroupService visitGroupService;
