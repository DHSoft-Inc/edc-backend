 ...
 * @generated
 */
public abstract class ResearcherFinderBaseImpl
	extends BasePersistenceImpl<Researcher> {

	public ResearcherFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return researcherPersistence.getBadColumnNames();
	}
