...
import com.dhsoft.edc.backend.service.InstitutionService;
import com.dhsoft.edc.backend.service.InstitutionServiceUtil;
...
/**
 * Provides the base implementation for the institution remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.dhsoft.edc.backend.service.impl.InstitutionServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.dhsoft.edc.backend.service.impl.InstitutionServiceImpl
 * @generated
 */
public abstract class InstitutionServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, InstitutionService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>InstitutionService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>InstitutionServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			InstitutionService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		institutionService = (InstitutionService)aopProxy;

		_setServiceUtilService(institutionService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return InstitutionService.class.getName();
	}
	...
	private void _setServiceUtilService(InstitutionService institutionService) {
		try {
			Field field = InstitutionServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, institutionService);
		}
	...
	@Reference
	protected com.dhsoft.edc.backend.service.InstitutionLocalService
