...
import com.dhsoft.edc.backend.service.ApprovalRequestService;
import com.dhsoft.edc.backend.service.ApprovalRequestServiceUtil;
...
/**
 * Provides the base implementation for the approval request remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.dhsoft.edc.backend.service.impl.ApprovalRequestServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.dhsoft.edc.backend.service.impl.ApprovalRequestServiceImpl
 * @generated
 */
public abstract class ApprovalRequestServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, ApprovalRequestService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ApprovalRequestService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ApprovalRequestServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ApprovalRequestService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		approvalRequestService = (ApprovalRequestService)aopProxy;

		_setServiceUtilService(approvalRequestService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ApprovalRequestService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = ApprovalRequestServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, approvalRequestService);
		}
	...
	@Reference
	protected com.dhsoft.edc.backend.service.ApprovalRequestLocalService
