...
import com.dhsoft.edc.backend.service.VisitDefinitionService;
import com.dhsoft.edc.backend.service.VisitDefinitionServiceUtil;
...
/**
 * Provides the base implementation for the visit definition remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.dhsoft.edc.backend.service.impl.VisitDefinitionServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.dhsoft.edc.backend.service.impl.VisitDefinitionServiceImpl
 * @generated
 */
public abstract class VisitDefinitionServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, VisitDefinitionService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>VisitDefinitionService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>VisitDefinitionServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			VisitDefinitionService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		visitDefinitionService = (VisitDefinitionService)aopProxy;

		_setServiceUtilService(visitDefinitionService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return VisitDefinitionService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = VisitDefinitionServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, visitDefinitionService);
		}
	...
	@Reference
	protected com.dhsoft.edc.backend.service.VisitDefinitionLocalService
		visitDefinitionLocalService;

	protected VisitDefinitionService visitDefinitionService;
