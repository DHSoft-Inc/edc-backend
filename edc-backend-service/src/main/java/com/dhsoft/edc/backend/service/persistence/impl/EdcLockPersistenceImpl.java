...
public class EdcLockPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByP_T;
	private FinderPath _finderPathWithoutPaginationFindByP_T;
	 ...
	 */
	@Override
	public List<EdcLock> findByP_T(long projectId, String lockType) {
		return findByP_T(
			projectId, lockType, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<EdcLock> findByP_T(
		long projectId, String lockType, int start, int end) {

		return findByP_T(projectId, lockType, start, end, null);
	}
	...
	public List<EdcLock> findByP_T(
		...
		return findByP_T(
			projectId, lockType, start, end, orderByComparator, true);
	}
	...
	public List<EdcLock> findByP_T(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByP_T;
				finderArgs = new Object[] {projectId, lockType};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByP_T;
			finderArgs = new Object[] {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_P_T_PROJECTID_2);

			boolean bindLockType = false;

			if (lockType.isEmpty()) {
				sb.append(_FINDER_COLUMN_P_T_LOCKTYPE_3);
			}
			else {
				bindLockType = true;

				sb.append(_FINDER_COLUMN_P_T_LOCKTYPE_2);
			}
	 ...
	 */
	@Override
	public EdcLock findByP_T_First(
			long projectId, String lockType,
			OrderByComparator<EdcLock> orderByComparator)
		throws NoSuchEdcLockException {

		EdcLock edcLock = fetchByP_T_First(
	 ...
	 */
	@Override
	public EdcLock fetchByP_T_First(
		long projectId, String lockType,
		OrderByComparator<EdcLock> orderByComparator) {

		List<EdcLock> list = findByP_T(
			projectId, lockType, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public EdcLock findByP_T_Last(
			long projectId, String lockType,
			OrderByComparator<EdcLock> orderByComparator)
		throws NoSuchEdcLockException {

		EdcLock edcLock = fetchByP_T_Last(
			projectId, lockType, orderByComparator);
	 ...
	 */
	@Override
	public EdcLock fetchByP_T_Last(
		long projectId, String lockType,
		OrderByComparator<EdcLock> orderByComparator) {

		int count = countByP_T(projectId, lockType);
		...
		List<EdcLock> list = findByP_T(
			projectId, lockType, count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public EdcLock[] findByP_T_PrevAndNext(
		...
		try {
			...
			array[0] = getByP_T_PrevAndNext(
				session, edcLock, projectId, lockType, orderByComparator, true);

			array[1] = edcLock;

			array[2] = getByP_T_PrevAndNext(
				session, edcLock, projectId, lockType, orderByComparator,
				false);
	...
	protected EdcLock getByP_T_PrevAndNext(
		Session session, EdcLock edcLock, long projectId, String lockType,
		OrderByComparator<EdcLock> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public void removeByP_T(long projectId, String lockType) {
		for (EdcLock edcLock :
				findByP_T(
					projectId, lockType, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
					null)) {
	 ...
	 */
	@Override
	public int countByP_T(long projectId, String lockType) {
		lockType = Objects.toString(lockType, "");

		FinderPath finderPath = _finderPathCountByP_T;

		Object[] finderArgs = new Object[] {projectId, lockType};
	...
	private static final String _FINDER_COLUMN_P_T_PROJECTID_2 =
		"edcLock.projectId = ? AND ";

	private static final String _FINDER_COLUMN_P_T_LOCKTYPE_2 =
		"edcLock.lockType = ?";

	private static final String _FINDER_COLUMN_P_T_LOCKTYPE_3 =
	...
	public EdcLock updateImpl(EdcLock edcLock) {
		...
		if (!_columnBitmaskEnabled) {
			...
			args = new Object[] {
				edcLockModelImpl.getProjectId(), edcLockModelImpl.getLockType()
			};

			finderCache.removeResult(_finderPathCountByP_T, args);
			finderCache.removeResult(
				_finderPathWithoutPaginationFindByP_T, args);
			...
			if ((edcLockModelImpl.getColumnBitmask() &
				 _finderPathWithoutPaginationFindByP_T.getColumnBitmask()) !=
					 0) {
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByP_T = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, EdcLockImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByP_T",
			new String[] {
		...
		_finderPathWithoutPaginationFindByP_T = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, EdcLockImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByP_T",
